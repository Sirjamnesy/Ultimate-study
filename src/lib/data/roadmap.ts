...
export const weeks: Week[] = [
  // ===== PHASE 1: AI Foundations (Weeks 1-4) =====
  {
    ...
    resources: [
      ...
      { id: "w1-3", title: "Anthropic Skilljar: Claude 101", url: "https://anthropic.skilljar.com/page/claude-101", type: "course" },
      { id: "w1-4", title: "Anthropic Skilljar: AI Fluency Framework & Foundations", url: "https://anthropic.skilljar.com/page/ai-fluency-framework-foundations", type: "course" },
      ...
      { id: "w1-q", title: "Quiz: AI Fundamentals (10 questions)", url: "/quiz/week-1", type: "quiz" },
    ],
  },
  {
    id: 2,
    ...
    resources: [
      ...
      { id: "w2-3", title: "Anthropic Skilljar: Building with Claude API", url: "https://anthropic.skilljar.com/page/claude-with-the-anthropic-api", type: "course" },
      ...
      { id: "w2-q", title: "Quiz: GenAI concepts + API basics (10 questions)", url: "/quiz/week-2", type: "quiz" },
    ],
  },
  {
    id: 3,
    ...
    resources: [
      ...
      { id: "w3-q", title: "Quiz: Prompt techniques (15 questions)", url: "/quiz/week-3", type: "quiz" },
    ],
  },
  {
    id: 4,
    ...
    resources: [
      ...
      { id: "w4-q", title: "Phase 1 Review Quiz: 20 questions across all weeks", url: "/quiz/week-4", type: "quiz" },
    ],
  },
  ...
  // ===== PHASE 2: AI Engineering Deep Dive (Weeks 5-12) =====
  {
    ...
    resources: [
      ...
      { id: "w5-q", title: "Quiz: Git basics + Tool schemas (15 questions)", url: "/quiz/week-5", type: "quiz" },
    ],
  },
  {
    id: 6,
    ...
    examDomains: [2],
    resources: [
      { id: "w6-1", title: "Anthropic Skilljar: Introduction to MCP", url: "https://anthropic.skilljar.com/page/introduction-to-model-context-protocol", type: "course" },
      ...
      { id: "w6-q", title: "Quiz: MCP protocol, transports, server/client (15 questions)", url: "/quiz/week-6", type: "quiz" },
    ],
  },
  {
    id: 7,
    ...
    examDomains: [2, 3],
    resources: [
      { id: "w7-1", title: "Anthropic Skilljar: MCP Advanced Topics", url: "https://anthropic.skilljar.com/page/model-context-protocol-advanced-topics", type: "course" },
      { id: "w7-2", title: "Anthropic Skilljar: Introduction to Agent Skills", url: "https://anthropic.skilljar.com/page/introduction-to-agent-skills", type: "course" },
      ...
      { id: "w7-q", title: "Quiz: MCP security, skills, advanced patterns (15 questions)", url: "/quiz/week-7", type: "quiz" },
    ],
  },
  {
    id: 8,
    ...
    examDomains: [3],
    resources: [
      { id: "w8-1", title: "Anthropic Skilljar: Claude Code in Action (6 hours)", url: "https://anthropic.skilljar.com/page/claude-code-in-action", type: "course", duration: "6hr" },
      { id: "w8-2", title: "Anthropic Skilljar: Introduction to Claude Cowork", url: "https://anthropic.skilljar.com/page/introduction-to-claude-cowork", type: "course" },
      ...
      { id: "w8-q", title: "Quiz: Claude Code configuration, hooks, plan mode (15 questions)", url: "/quiz/week-8", type: "quiz" },
    ],
  },
  {
    id: 9,
    ...
    resources: [
      ...
      { id: "w9-q", title: "Quiz: Open-source models, transformers, model hub (10 questions)", url: "/quiz/week-9", type: "quiz" },
    ],
  },
  {
    id: 10,
    ...
    resources: [
      ...
      { id: "w10-q", title: "Quiz: LangChain concepts, chains, orchestration (10 questions)", url: "/quiz/week-10", type: "quiz" },
    ],
  },
  {
    id: 11,
    ...
    resources: [
      ...
      { id: "w11-3", title: "Anthropic Skilljar: Introduction to Subagents", url: "https://anthropic.skilljar.com/page/introduction-to-subagents", type: "course" },
      ...
      { id: "w11-q", title: "Quiz: RAG architecture + Agent patterns (15 questions)", url: "/quiz/week-11", type: "quiz" },
    ],
  },
  {
    id: 12,
    ...
    resources: [
      ...
      { id: "w12-3", title: "Architect's Playbook: Structured Data Extraction (pages 2-9)", url: "/architects-playbook.pdf", type: "reading" },
      { id: "w12-4", title: "Build: Data extraction pipeline (doc -> validated JSON)", type: "build" },
      { id: "w12-q", title: "Phase 2 Capstone Quiz: 30 questions", url: "/quiz/week-12", type: "quiz" },
    ],
  },
  ...
  // ===== PHASE 3: Architect Exam Sprint (Weeks 13-18) =====
  {
    ...
    resources: [
      ...
      { id: "w13-2", title: "Architect's Playbook: Customer Support + Multi-Agent Systems", url: "/architects-playbook.pdf", type: "reading" },
      ...
      { id: "w13-5", title: "claudecertifications.com: Domain 1 practice questions", url: "https://claudecertifications.com/claude-certified-architect/domains/agentic-architecture", type: "practice" },
      { id: "w13-6", title: "Exam Guide: format, scenarios, and anti-patterns", url: "https://claudecertifications.com/claude-certified-architect/exam-guide", type: "docs" },
      { id: "w13-q", title: "Domain 1 Quiz: 20 questions (agentic loops, subagents, hooks)", url: "/quiz/domain-1", type: "quiz" },
    ],
  },
  {
    id: 14,
    ...
    resources: [
      ...
      { id: "w14-4", title: "Architect's Playbook: Developer Productivity + MCP Tool Specificity", url: "/architects-playbook.pdf", type: "reading" },
      { id: "w14-5", title: "claudecertifications.com: Domain 2+3 practice questions", url: "https://claudecertifications.com/claude-certified-architect/practice-questions", type: "practice" },
      { id: "w14-6", title: "Build: Developer productivity tool with Claude Code", type: "build" },
      { id: "w14-q", title: "Domain 2+3 Quiz: 25 questions (tool design, MCP, CLAUDE.md)", url: "/quiz/domain-2", type: "quiz" },
    ],
  },
  {
    id: 15,
    ...
    resources: [
      ...
      { id: "w15-2", title: "Architect's Playbook: Resilient Schemas, Normalization, Null Handling", url: "/architects-playbook.pdf", type: "reading" },
      { id: "w15-3", title: "Exam Exercise 3: Structured Data Extraction Pipeline", type: "build" },
      { id: "w15-4", title: "claudecertifications.com: Domain 4 practice questions", url: "https://claudecertifications.com/claude-certified-architect/domains/prompt-engineering", type: "practice" },
      { id: "w15-5", title: "Build: Full extraction pipeline with validation + retry", type: "build" },
      { id: "w15-q", title: "Domain 4 Quiz: 20 questions (few-shot, JSON schemas, batch)", url: "/quiz/domain-4", type: "quiz" },
    ],
  },
  {
    id: 16,
    ...
    resources: [
      ...
      { id: "w16-3", title: "Architect's Playbook: Compressing Sessions, Tool Context Pruning", url: "/architects-playbook.pdf", type: "reading" },
      { id: "w16-4", title: "claudecertifications.com: Domain 5 practice questions", url: "https://claudecertifications.com/claude-certified-architect/domains/context-management", type: "practice" },
      { id: "w16-5", title: "Build: Research system with context management", type: "build" },
      { id: "w16-q", title: "Domain 5 Quiz: 15 questions (context pruning, escalation)", url: "/quiz/domain-5", type: "quiz" },
    ],
  },
  {
    id: 17,
    ...
    resources: [
      { id: "w17-1", title: "Scenario 1: Customer Support — routing, escalation, and tool integration (D1, D2, D5)", url: "https://claudecertifications.com/claude-certified-architect/exam-guide", type: "practice" },
      { id: "w17-2", title: "Scenario 2: Code Generation — Claude Code integration and output validation (D3, D5)", url: "https://docs.anthropic.com/en/docs/claude-code", type: "practice" },
      { id: "w17-3", title: "Scenario 3: Multi-Agent Research — coordinator + specialist agents with provenance (D1, D2, D5)", url: "https://docs.anthropic.com/en/docs/agents", type: "practice" },
      { id: "w17-4", title: "Scenario 4: Developer Productivity — MCP servers, hooks, and custom commands (D2, D3, D1)", url: "https://docs.anthropic.com/en/docs/claude-code", type: "practice" },
      { id: "w17-5", title: "Scenario 5: CI/CD Pipeline — restricted permissions and automated checks (D3, D4)", url: "https://docs.anthropic.com/en/docs/claude-code", type: "practice" },
      { id: "w17-6", title: "Scenario 6: Structured Data Extraction — schema validation, retries, batch processing (D4, D5)", url: "https://docs.anthropic.com/en/docs/build-with-claude/structured-output", type: "practice" },
      { id: "w17-7", title: "Review: 25 practice questions with detailed explanations", url: "https://claudecertifications.com/claude-certified-architect/practice-questions", type: "practice" },
      { id: "w17-q", title: "Cross-domain quiz: 30 questions mixing all domains", url: "/quiz/week-17", type: "quiz" },
    ],
  },
  {
    id: 18,
    ...
    examDomains: [1, 2, 3, 4, 5],
    resources: [
      { id: "w18-1", title: "Mock Exam 1: Full 90-minute simulation (4 scenarios, domain-weighted)", url: "https://claudecertifications.com/claude-certified-architect/practice-questions", type: "practice" },
      { id: "w18-2", title: "Review: Identify weak domains from Mock 1, re-study relevant Anthropic docs", type: "practice" },
      { id: "w18-3", title: "Mock Exam 2: Full simulation — target 80%+ on every domain", url: "https://claudecertifications.com/claude-certified-architect/practice-questions", type: "practice" },
      { id: "w18-4", title: "Review: Focus on scenario timing and cross-domain connections", type: "practice" },
      { id: "w18-5", title: "Mock Exam 3: Final confidence check under exam-day conditions", url: "https://claudecertifications.com/claude-certified-architect/practice-questions", type: "practice" },
      { id: "w18-6", title: "Register and schedule the Claude Certified Architect exam", url: "https://anthropic.skilljar.com/claude-certified-architect-foundations-access-request", type: "practice" },
    ],
  },
  ...
  // ===== PHASE 4: Production AI & LLMOps (Weeks 19-22) =====
  {
    ...
    xp: 400,
    resources: [
      { id: "w19-1", title: "LLMOps lifecycle: from idea to production", url: "https://www.deeplearning.ai/courses/llmops/", type: "docs", source: "Baraa: LLMOps" },
      ...
      { id: "w19-q", title: "Quiz: LLMOps concepts, monitoring, cost tracking (10 questions)", url: "/quiz/week-19", type: "quiz" },
    ],
  },
  {
    id: 20,
    ...
    xp: 500,
    resources: [
      { id: "w20-1", title: "Anthropic Skilljar: Claude with Amazon Bedrock", url: "https://anthropic.skilljar.com/page/claude-in-amazon-bedrock", type: "course" },
      { id: "w20-2", title: "Anthropic Skilljar: Claude with Google Cloud Vertex AI", url: "https://anthropic.skilljar.com/page/claude-with-google-vertex", type: "course" },
      { id: "w20-3", title: "CI/CD for model updates, alerts, dashboards", url: "https://docs.anthropic.com/en/docs/build-with-claude/monitor-and-evaluate", type: "practice", source: "Baraa: LLMOps" },
  ...
  },
  {
    ...
    xp: 500,
    resources: [
      { id: "w21-1", title: "Anthropic docs: Multi-agent orchestration and handoff patterns", url: "https://docs.anthropic.com/en/docs/agents", type: "docs" },
      { id: "w21-2", title: "Anthropic docs: Evaluating and testing AI agents", url: "https://docs.anthropic.com/en/docs/build-with-claude/monitor-and-evaluate", type: "docs" },
      { id: "w21-3", title: "Practice: Build agents that call APIs, query databases, trigger workflows", url: "https://docs.anthropic.com/en/docs/build-with-claude/tool-use", type: "practice", source: "Baraa: AI Agents" },
  ...
  },
  {
    ...
    resources: [
      ...
      { id: "w22-2", title: "Deploy models safely on Hugging Face", url: "https://huggingface.co/docs/hub/models-deploying", type: "practice", source: "Baraa: Hugging Face" },
  ...
  // ===== PHASE 5: Portfolio & Career (Weeks 23-26) =====
  {
    ...
    xp: 500,
    resources: [
      { id: "w23-1", title: "Build: RAG 'Talk to Documents' app — PDF upload, vector search, Q&A with source citations", type: "build" },
      { id: "w23-2", title: "Pinecone docs: Vector database setup, indexing, and querying", url: "https://docs.pinecone.io/guides/get-started/overview", type: "docs" },
      { id: "w23-3", title: "LangChain RAG tutorial: Document loading, text chunking, retrieval chain", url: "https://python.langchain.com/docs/tutorials/rag/", type: "docs" },
      { id: "w23-4", title: "Streamlit docs: Build a chat interface with file upload widget", url: "https://docs.streamlit.io/develop/tutorials/chat-and-llm-apps/build-a-chatbot", type: "docs" },
      { id: "w23-5", title: "Build: Add conversation memory, architecture diagram, and README", type: "build" },
    ],
  },
  {
    id: 24,
    ...
    xp: 500,
    resources: [
      { id: "w24-1", title: "Build: SQL Data Analyst Agent — natural language to SQL with chart output and summary", type: "build" },
      { id: "w24-2", title: "LangChain SQL Agent: Text-to-SQL chains and database toolkit", url: "https://python.langchain.com/docs/tutorials/sql_qa/", type: "docs" },
      { id: "w24-3", title: "Anthropic Cookbook: Tool use patterns for database queries", url: "https://github.com/anthropics/anthropic-cookbook/tree/main/tool_use", type: "docs" },
      { id: "w24-4", title: "Build: Add error handling, chart visualization, and demo GIF to README", type: "build" },
    ],
  },
  {
    id: 25,
    ...
    xp: 400,
    resources: [
      { id: "w25-1", title: "Anthropic Skilljar: Teaching AI Fluency", url: "https://anthropic.skilljar.com/page/teaching-ai-fluency", type: "course" },
      { id: "w25-2", title: "Anthropic Skilljar: AI Fluency for Educators", url: "https://anthropic.skilljar.com/page/ai-fluency-for-educators", type: "course" },
  ...
  },
  {
    ...
    resources: [
      ...
      { id: "w26-4", title: "Review: Azure AI-102, Databricks GenAI certifications", url: "https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-engineer/", type: "docs", source: "Baraa: Certifications" },
