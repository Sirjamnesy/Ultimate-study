...
export function CheckoutForm({ detectedCurrency }: { detectedCurrency: PaystackCurrency }) {
  ...
  return (
    <div className="sketch-card bg-card p-8 rounded-2xl text-center">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        <div
          className={cn(
            "sketch-border-sm rounded-xl p-4 bg-emerald-500/5 border-emerald-500/30",
            detectedCurrency === "NGN" && "ring-2 ring-emerald-400/60"
          )}
        >
        ...
        <div
          className={cn(
            "sketch-border-sm rounded-xl p-4 bg-blue-500/5 border-blue-500/30",
            detectedCurrency === "USD" && "ring-2 ring-blue-400/60"
          )}
        >
          <div className="text-xs text-muted-foreground mb-1 flex items-center justify-center gap-1">
